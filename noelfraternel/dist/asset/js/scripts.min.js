...
function _typeof(e) {
    ...
    function w(e, t, n) {
        var i, o, s = (n = n || x).createElement("script");
        if (s.text = e, t)
            for (i in c)(o = t[i] || t.getAttribute && t.getAttribute(i)) && s.setAttribute(i, o);
    ...
    k.fn = k.prototype = {
        ...
        var e, t, n, i, o, s = arguments[0] || {},
            ...
            a = arguments.length,
            l = !1;
        for ("boolean" == typeof s && (l = s, s = arguments[r] || {}, r++), "object" == _typeof(s) || b(s) || (s = {}), r === a && (s = this, r--); r < a; r++)
        ...
        isPlainObject: function(e) {
            return !(!e || "[object Object]" !== s.call(e) || (e = n(e)) && ("function" != typeof(e = v.call(e, "constructor") && e.constructor) || r.call(e) !== u))
        },
    ...
    var p = function(n) {
        ...
        var e, p, w, s, o, h, f, g, _, l, u, T, C, r, x, m, a, c, v, k = "sizzle" + +new Date,
            y = n.document,
            S = 0,
            b = 0,
            E = le(),
            ...
            if (!i && (T(t), t = t || C, x)) {
                if (11 !== f && (l = te.exec(e)))
                    if (o = l[1]) {
                        ...
                        } else if (d && (r = d.getElementById(o)) && v(t, r) && r.id === o) return n.push(r), n
                    } else {
                    ...
                    if (c = e, d = t, 1 === f && (X.test(e) || Q.test(e))) {
                        for ((d = ne.test(e) && ge(t.parentNode) || t) === t && p.scope || ((a = t.getAttribute("id")) ? a = a.replace(oe, se) : t.setAttribute("id", a = k)), s = (u = h(e)).length; s--;) u[s] = (a ? "#" + a : ":scope") + " " + ve(u[s]);
                        c = u.join(",")
                    }
                    try {
        ...
        for (e in p = ae.support = {}, o = ae.isXML = function(e) {
                ...
                return e != C && 9 === e.nodeType && e.documentElement && (r = (C = e).documentElement, x = !o(C), y != C && (t = C.defaultView) && t.top !== t && (t.addEventListener ? t.addEventListener("unload", i, !1) : t.attachEvent && t.attachEvent("onunload", i)), p.scope = ce(function(e) {
                    return r.appendChild(e).appendChild(C.createElement("div")), void 0 !== e.querySelectorAll && !e.querySelectorAll(":scope fieldset div").length
                ...
                }, a = [], m = [], (p.qsa = ee.test(C.querySelectorAll)) && (ce(function(e) {
                    var t;
                    ...
                    t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && m.push("name" + M + "*[*^$|!~]?="), 2 !== e.querySelectorAll(":enabled").length && m.push(":enabled", ":disabled"), r.appendChild(e).disabled = !0, 2 !== e.querySelectorAll(":disabled").length && m.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), m.push(",.*:")
                })), (p.matchesSelector = ee.test(c = r.matches || r.webkitMatchesSelector || r.mozMatchesSelector || r.oMatchesSelector || r.msMatchesSelector)) && ce(function(e) {
                    ...
                    return n || (1 & (n = (e.ownerDocument || e) == (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !p.sortDetached && t.compareDocumentPosition(e) === n ? e == C || e.ownerDocument == y && v(y, e) ? -1 : t == C || t.ownerDocument == y && v(y, t) ? 1 : l ? P(l, e) - P(l, t) : 0 : 4 & n ? -1 : 1)
                } : function(e, t) {
                    if (e === t) return u = !0, 0;
                    var n, i = 0,
                        o = e.parentNode,
                        ...
                        r = [e],
                        a = [t];
                    if (!o || !s) return e == C ? -1 : t == C ? 1 : o ? -1 : s ? 1 : l ? P(l, e) - P(l, t) : 0;
                    if (o === s) return fe(e, t);
                    for (n = e; n = n.parentNode;) r.unshift(n);
                    for (n = t; n = n.parentNode;) a.unshift(n);
                    for (; r[i] === a[i];) i++;
                    return i ? fe(r[i], a[i]) : r[i] == y ? -1 : a[i] == y ? 1 : 0
                }), C
            }, ae.matches = function(e, t) {
                return ae(e, null, null, t)
            }, ae.matchesSelector = function(e, t) {
                if (T(e), p.matchesSelector && x && !D[t + " "] && (!a || !a.test(t)) && (!m || !m.test(t))) try {
                    var n = c.call(e, t);
                ...
                var n = w.attrHandle[t.toLowerCase()],
                    n = n && j.call(w.attrHandle, t.toLowerCase()) ? n(e, t, !x) : void 0;
                ...
                filter: {
                        ...
                        return 1 === g && 0 === m ? function(e) {
                            ...
                            if (c) {
                                ...
                                if (l = [y ? c.firstChild : c.lastChild], y && f) {
                                    for (p = (a = (i = (o = (s = (r = c)[k] || (r[k] = {}))[r.uniqueID] || (s[r.uniqueID] = {}))[h] || [])[0] === S && i[1]) && i[2], r = a && c.childNodes[a]; r = ++a && r && r[u] || (p = a = 0) || l.pop();)
                                        if (1 === r.nodeType && ++p && r === e) {
                                            o[h] = [S, a, p];
                                            break
                                        }
                                } else if (f && (p = a = (i = (o = (s = (r = e)[k] || (r[k] = {}))[r.uniqueID] || (s[r.uniqueID] = {}))[h] || [])[0] === S && i[1]), !1 === p)
                                    for (;
                                        (r = ++a && r && r[u] || (p = a = 0) || l.pop()) && ((b ? r.nodeName.toLowerCase() !== d : 1 !== r.nodeType) || !++p || (f && ((o = (s = r[k] || (r[k] = {}))[r.uniqueID] || (s[r.uniqueID] = {}))[h] = [S, p]), r !== e)););
                    ...
                    PSEUDO: function(e, s) {
                        ...
                        return r[k] ? r(s) : 1 < r.length ? (t = [e, e, "", s], w.setFilters.hasOwnProperty(e.toLowerCase()) ? ue(function(e, t) {
                ...
                pseudos: {
                    not: ue(function(e) {
                        var i = [],
                            o = [],
                            a = f(e.replace(B, "$1"));
                        return a[k] ? ue(function(e, t, n, i) {
                    ...
                    lang: ue(function(n) {
                        return Y.test(n || "") || ae.error("unsupported lang: " + n), n = n.replace(ie, d).toLowerCase(),
                            function(e) {
                                var t;
                                do {
        ...
        function _e(e) {
            for (var i, t, n, o = e.length, s = w.relative[e[0].type], r = s || w.relative[" "], a = s ? 1 : 0, l = ye(function(e) {
                    ...
                    return -1 < P(i, e)
                }, r, !0), c = [function(e, t, n) {
                    n = !s && (n || t !== _) || ((i = t).nodeType ? l : u)(e, t, n);
                    return i = null, n
                }]; a < o; a++)
                if (t = w.relative[e[a].type]) c = [ye(be(c), t)];
                    ...
                    if ((t = w.filter[e[a].type].apply(null, e[a].matches))[k]) {
                        ...
                        return function e(p, h, g, m, v, t) {
                            return m && !m[k] && (m = e(m)), v && !v[k] && (v = e(v, t)), ue(function(e, t, n, i) {
                                var o, s, r, a = [],
                                    l = [],
                                    u = t.length,
                                    c = e || function(e, t, n) {
                                    ...
                                    d = !p || !e && h ? c : we(c, a, p, n, i),
                                    f = g ? v || (e ? p : u || m) ? [] : t : d;
                                if (g && g(d, f, n, i), m)
                                    for (o = we(f, l), m(o, [], n, i), s = o.length; s--;)(r = o[s]) && (f[l[s]] = !(d[l[s]] = r));
                                if (e) {
                                    if (v || p) {
                                        if (v) {
                                            for (o = [], s = f.length; s--;)(r = f[s]) && o.push(d[s] = r);
                                            v(null, f = [], o, i)
                                        }
                                        for (s = f.length; s--;)(r = f[s]) && -1 < (o = v ? P(e, r) : a[s]) && (e[o] = !(t[o] = r))
                                    }
                                } else f = we(f === t ? f.splice(u, f.length) : f), v ? v(null, t, f, i) : L.apply(t, f)
                            })
                        }(1 < a && be(c), 1 < a && ve(e.slice(0, a - 1).concat({
                            value: " " === e[a - 2].type ? "*" : ""
                        })).replace(B, "$1"), t, a < n && _e(e.slice(a, n)), n < o && _e(e = e.slice(n)), n < o && ve(e))
                    }
                    c.push(t)
                } return be(c)
        }
        return me.prototype = w.filters = w.pseudos, w.setFilters = new me, h = ae.tokenize = function(e, t) {
            var n, i, o, s, r, a, l, u = A[e + " "];
            if (u) return t ? 0 : u.slice(0);
            for (r = e, a = [], l = w.preFilter; r;) {
                for (s in n && !(i = U.exec(r)) || (i && (r = r.slice(i[0].length) || r), a.push(o = [])), n = !1, (i = Q.exec(r)) && (n = i.shift(), o.push({
                        value: n,
                        type: i[0].replace(B, " ")
            ...
            var n, m, v, y, b, i, o = [],
                ...
                r = $[e + " "];
            if (!r) {
                for (n = (t = t || h(e)).length; n--;)((r = _e(t[n]))[k] ? o : s).push(r);
                (r = $(e, (m = s, y = 0 < (v = o).length, b = 0 < m.length, i = function(e, t, n, i, o) {
                    var s, r, a, l = 0,
                        u = "0",
                        c = e && [],
                        d = [],
                        ...
                        g = p.length;
                    for (o && (_ = t == C || t || o); u !== g && null != (s = p[u]); u++) {
                        if (b && s) {
                            for (r = 0, t || s.ownerDocument == C || (T(s), n = !x); a = m[r++];)
                                if (a(s, t || C, n)) {
                                    i.push(s);
                                    break
                                } o && (S = h)
            ...
            if (n = n || [], 1 === c.length) {
                if (2 < (s = c[0] = c[0].slice(0)).length && "ID" === (r = s[0]).type && 9 === t.nodeType && x && w.relative[s[1].type]) {
                    if (!(t = (w.find.ID(r.matches[0].replace(ie, d), t) || [])[0])) return n;
                    u && (t = t.parentNode), e = e.slice(s.shift().value.length)
                }
                for (o = K.needsContext.test(e) ? 0 : s.length; o-- && (r = s[o], !w.relative[a = r.type]);)
                    if ((l = w.find[a]) && (i = l(r.matches[0].replace(ie, d), ne.test(s[0].type) && ge(t.parentNode) || t))) {
                        if (s.splice(o, 1), !(e = i.length && ve(s))) return L.apply(n, i), n;
                        break
                    }
            }
            return (u || f(e, c))(i, t, !x, n, !t || ne.test(e) && ge(t.parentNode) || t), n
        }, p.sortStable = k.split("").sort(N).join("") === k, p.detectDuplicates = !!u, T(), p.sortDetached = ce(function(e) {
    ...
    k.filter = function(e, t, n) {
        ...
        is: function(e) {
            return !!$(this, "string" == typeof e && S.test(e) ? k(e) : e || [], !1).length
        }
    });
    var D, N = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    (k.fn.init = function(e, t, n) {
        if (!e) return this;
        if (n = n || D, "string" != typeof e) return e.nodeType ? (this[0] = e, this.length = 1, this) : b(e) ? void 0 !== n.ready ? n.ready(e) : e(k) : k.makeArray(e, this);
        if (!(i = "<" === e[0] && ">" === e[e.length - 1] && 3 <= e.length ? [null, e, null] : N.exec(e)) || !i[1] && t) return (!t || t.jquery ? t || n : this.constructor(t)).find(e);
        if (i[1]) {
            if (t = t instanceof k ? t[0] : t, k.merge(this, k.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : x, !0)), A.test(i[1]) && k.isPlainObject(t))
                for (var i in t) b(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
            return this
        }
        return (e = x.getElementById(i[2])) && (this[0] = e, this.length = 1), this
    }).prototype = k.fn, D = k(x);
    ...
    k.fn.extend({
        ...
        contents: function(e) {
            return null != e.contentDocument && n(e.contentDocument) ? e.contentDocument : (E(e, "template") && (e = e.content || e), k.merge([], e.childNodes))
        }
    }, function(i, o) {
        k.fn[i] = function(e, t) {
            var n = k.map(this, o, e);
            return "Until" !== i.slice(-5) && (t = e), t && "string" == typeof t && (n = k.filter(t, n)), 1 < this.length && (O[i] || k.uniqueSort(n), j.test(i) && n.reverse()), this.pushStack(n)
        }
    });
    var L = /[^\x20\t\r\n\f]+/g;
    ...
    k.Callbacks = function(i) {
        var n;
        i = "string" == typeof i ? (n = {}, k.each(i.match(L) || [], function(e, t) {
            n[t] = !0
        }), n) : k.extend({}, i);

        function o() {
            for (r = r || i.once, t = s = !0; l.length; u = -1)
        ...
        var s, e, t, r, a = [],
            ...
            c = {
                add: function() {
                    return a && (e && !s && (u = a.length - 1, l.push(e)), function n(e) {
                        k.each(e, function(e, t) {
                            b(t) ? i.unique && c.has(t) || a.push(t) : t && t.length && "string" !== h(t) && n(t)
                        })
                ...
                r = {
                    ...
                    then: function(t, n, i) {
                            ...
                            return function() {
                                function e() {
                                    ...
                                    if (!(o < l)) {
                                        ...
                                        t = e && ("object" == _typeof(e) || "function" == typeof e) && e.then, b(t) ? a ? t.call(e, u(l, s, q, a), u(l, s, P, a)) : (l++, t.call(e, u(l, s, q, a), u(l, s, P, a), u(l, s, q, s.notifyWith))) : (r !== q && (n = void 0, i = [e]), (a || s.resolveWith)(n, i))
                                    }
                                }
                                var n = this,
                                    i = arguments,
                                    t = a ? e : function() {
                                        try {
                                            ...
                                            k.Deferred.exceptionHook && k.Deferred.exceptionHook(e, t.stackTrace), l <= o + 1 && (r !== P && (n = void 0, i = [e]), s.rejectWith(n, i))
                                        }
                                    };
                        ...
                        return k.Deferred(function(e) {
                            s[0][3].add(u(0, e, b(i) ? i : q, e.notifyWith)), s[1][3].add(u(0, e, b(t) ? t : q)), s[2][3].add(u(0, e, b(n) ? n : P))
                        }).promise()
                    },
                    promise: function(e) {
        ...
        when: function(e) {
            ...
            var n = arguments.length,
                ...
                s = a.call(arguments),
                r = k.Deferred();
            if (n <= 1 && (H(e, r.done(t(i)).resolve, r.reject, !n), "pending" === r.state() || b(s[i] && s[i].then))) return r.then();
            for (; i--;) H(s[i], t(i), r.reject);
            return r.promise()
        }
    });
    ...
    function z() {
        x.removeEventListener("DOMContentLoaded", z), C.removeEventListener("load", z), k.ready()
    }
    ...
    }), k.ready.then = R.then, "complete" === x.readyState || "loading" !== x.readyState && !x.documentElement.doScroll ? C.setTimeout(k.ready) : (x.addEventListener("DOMContentLoaded", z), C.addEventListener("load", z));

    function F(e, t, n, i, o, s, r) {
        var a = 0,
            l = e.length,
            u = null == n;
        if ("object" === h(n))
            for (a in o = !0, n) F(e, t, a, n[a], !0, s, r);
        else if (void 0 !== i && (o = !0, b(i) || (r = !0), u && (t = r ? (t.call(e, i), null) : (u = t, function(e, t, n) {
                return u.call(k(e), n)
            })), t))
    ...
    k.extend({
        ...
        data: function(n, e) {
            ...
            if (void 0 !== n) return "object" == _typeof(n) ? this.each(function() {
                ...
                var t;
                return s && void 0 === e ? void 0 !== (t = K.get(s, n)) || void 0 !== (t = Z(s, n)) ? t : void 0 : void this.each(function() {
                    K.set(this, n, e)
                })
            }, null, e, 1 < arguments.length, null, !0);
            if (this.length && (o = K.get(s), 1 === s.nodeType && !Y.get(s, "hasDataAttrs"))) {
                for (t = r.length; t--;) r[t] && 0 === (i = r[t].name).indexOf("data-") && (i = Q(i.slice(5)), Z(s, i, o[i]));
    ...
    function ae(e, t, n, i) {
        ...
        if (c && c[3] !== u) {
            for (l /= 2, u = u || c[3], c = +l || 1; r--;) k.style(e, t, c + u), (1 - s) * (1 - (s = a() / l || .5)) <= 0 && (r = 0), c /= s;
    ...
    function ue(e, t) {
        for (var n, i, o, s, r, a, l = [], u = 0, c = e.length; u < c; u++)(i = e[u]).style && (n = i.style.display, t ? ("none" === n && (l[u] = Y.get(i, "display") || null, l[u] || (i.style.display = "")), "" === i.style.display && re(i) && (l[u] = (a = s = o = void 0, s = i.ownerDocument, r = i.nodeName, (a = le[r]) || (o = s.body.appendChild(s.createElement(r)), a = k.css(o, "display"), o.parentNode.removeChild(o), "none" === a && (a = "block"), le[r] = a)))) : "none" !== n && (l[u] = "none", Y.set(i, "display", n)));
    ...
    (p = x.createElement("input")).setAttribute("type", "radio"), p.setAttribute("checked", "checked"), p.setAttribute("name", "t"), d.appendChild(p), y.checkClone = d.cloneNode(!0).cloneNode(!0).lastChild.checked, d.innerHTML = "<textarea>x</textarea>", y.noCloneChecked = !!d.cloneNode(!0).lastChild.defaultValue, d.innerHTML = "<option></option>", y.option = !!d.lastChild;
    var pe = {
        thead: [1, "<table>", "</table>"],
    ...
    function ve(e, t, n, i, o) {
        for (var s, r, a, l, u, c = t.createDocumentFragment(), d = [], f = 0, p = e.length; f < p; f++)
            if ((s = e[f]) || 0 === s)
                if ("object" === h(s)) k.merge(d, s.nodeType ? [s] : s);
                else if (me.test(s)) {
            for (r = r || c.appendChild(t.createElement("div")), a = (de.exec(s) || ["", ""])[1].toLowerCase(), a = pe[a] || pe._default, r.innerHTML = a[1] + k.htmlPrefilter(s) + a[2], u = a[0]; u--;) r = r.lastChild;
        ...
        for (c.textContent = "", f = 0; s = d[f++];)
            ...
            else if (l = oe(s), r = he(c.appendChild(s), "script"), l && ge(r), n)
    ...
    function ke(e, o, s) {
        s ? (Y.set(e, o, !1), k.event.add(e, o, {
            namespace: !1,
            handler: function(e) {
                var t, n, i = Y.get(this, o);
                if (1 & e.isTrigger && this[o]) {
                    if (i.length)(k.event.special[o] || {}).delegateType && e.stopPropagation();
                    else if (i = a.call(arguments), Y.set(this, o, i), t = s(this, o), this[o](), i !== (n = Y.get(this, o)) || t ? Y.set(this, o, !1) : n = {}, i !== n) return e.stopImmediatePropagation(), e.preventDefault(), n.value
                } else i.length && (Y.set(this, o, {
                    value: k.event.trigger(k.extend(i[0], k.Event.prototype), i.slice(1), this)
                }), e.stopImmediatePropagation())
            }
        })) : void 0 === Y.get(e, o) && k.event.add(e, o, _e)
    }
    k.event = {
        global: {},
        add: function(t, e, n, i, o) {
            var s, r, a, l, u, c, d, f, p, h = Y.get(t);
            if (X(t))
                for (n.handler && (n = (s = n).handler, o = s.selector), o && k.find.matchesSelector(ie, o), n.guid || (n.guid = k.guid++), (a = h.events) || (a = h.events = Object.create(null)), (r = h.handle) || (r = h.handle = function(e) {
                        return void 0 !== k && k.event.triggered !== e.type ? k.event.dispatch.apply(t, arguments) : void 0
                    }), l = (e = (e || "").match(L) || [""]).length; l--;) d = p = (u = we.exec(e[l]) || [])[1], f = (u[2] || "").split(".").sort(), d && (c = k.event.special[d] || {}, d = (o ? c.delegateType : c.bindType) || d, c = k.event.special[d] || {}, u = k.extend({
                    type: d,
                    origType: p,
                    data: i,
                    handler: n,
                    ...
                    namespace: f.join(".")
                }, s), (p = a[d]) || ((p = a[d] = []).delegateCount = 0, c.setup && !1 !== c.setup.call(t, i, f, r) || t.addEventListener && t.addEventListener(d, r)), c.add && (c.add.call(t, u), u.handler.guid || (u.handler.guid = n.guid)), o ? p.splice(p.delegateCount++, 0, u) : p.push(u), k.event.global[d] = !0)
        },
        remove: function(e, t, n, i, o) {
            var s, r, a, l, u, c, d, f, p, h, g, m = Y.hasData(e) && Y.get(e);
            if (m && (l = m.events)) {
                for (u = (t = (t || "").match(L) || [""]).length; u--;)
                    if (p = g = (a = we.exec(t[u]) || [])[1], h = (a[2] || "").split(".").sort(), p) {
                        for (d = k.event.special[p] || {}, f = l[p = (i ? d.delegateType : d.bindType) || p] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), r = s = f.length; s--;) c = f[s], !o && g !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (f.splice(s, 1), c.selector && f.delegateCount--, d.remove && d.remove.call(e, c));
                        r && !f.length && (d.teardown && !1 !== d.teardown.call(e, h, m.handle) || k.removeEvent(e, p, m.handle), delete l[p])
                    } else
                        for (p in l) k.event.remove(e, p + t[u], n, i, !0);
            ...
            if (l && u.nodeType && !("click" === e.type && 1 <= e.button))
                for (; u !== this; u = u.parentNode || this)
                    if (1 === u.nodeType && ("click" !== e.type || !0 !== u.disabled)) {
                        for (s = [], r = {}, n = 0; n < l; n++) void 0 === r[o = (i = t[n]).selector + " "] && (r[o] = i.needsContext ? -1 < k(o, this).index(u) : k.find(o, this, null, [u]).length), r[o] && s.push(i);
                        s.length && a.push({
                            elem: u,
                            handlers: s
                        })
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    e = this || e;
                    return ce.test(e.type) && e.click && E(e, "input") && ke(e, "click", _e), !1
                },
                trigger: function(e) {
                    e = this || e;
                    return ce.test(e.type) && e.click && E(e, "input") && ke(e, "click"), !0
                },
                _default: function(e) {
                    e = e.target;
                    return ce.test(e.type) && e.click && E(e, "input") && Y.get(e, "click") || E(e, "a")
                }
            },
            beforeunload: {
        ...
        e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? _e : Te, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && k.extend(this, t), this.timeStamp = e && e.timeStamp || Date.now(), this[k.expando] = !0
    }, k.Event.prototype = {
        constructor: k.Event,
    ...
    function Oe(n, i, o, s) {
        ...
        var e, t, r, a, l, u, c = 0,
            ...
            p = i[0],
            h = b(p);
        if (h || 1 < d && "string" == typeof p && !y.checkClone && Ee.test(p)) return n.each(function(e) {
            var t = n.eq(e);
            h && (i[0] = p.call(this, e, t.html())), Oe(t, i, o, s)
        });
        if (d && (t = (e = ve(i, n[0].ownerDocument, !1, n, s)).firstChild, 1 === e.childNodes.length && (e = t), t || s)) {
            for (a = (r = k.map(he(e, "script"), De)).length; c < d; c++) l = e, c !== f && (l = k.clone(l, !0, !0), a && k.merge(r, he(l, "script"))), o.call(n[c], l, c);
            if (a)
                for (u = r[r.length - 1].ownerDocument, k.map(r, Ne), c = 0; c < a; c++) l = r[c], fe.test(l.type || "") && !Y.access(l, "globalEval") && k.contains(u, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? k._evalUrl && !l.noModule && k._evalUrl(l.src, {
    ...
    function Ie(e, t, n) {
        for (var i, o = t ? k.filter(t, e) : e, s = 0; null != (i = o[s]); s++) n || 1 !== i.nodeType || k.cleanData(he(i)), i.parentNode && (n && oe(i) && ge(he(i, "script")), i.parentNode.removeChild(i));
        return e
    }
    k.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (!(y.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || k.isXMLDoc(e)))
                for (r = he(c), i = 0, o = (s = he(e)).length; i < o; i++) a = s[i], "input" === (u = (l = r[i]).nodeName.toLowerCase()) && ce.test(a.type) ? l.checked = a.checked : "input" !== u && "textarea" !== u || (l.defaultValue = a.defaultValue);
            if (t)
                if (n)
                    for (s = s || he(e), r = r || he(c), i = 0, o = s.length; i < o; i++) je(s[i], r[i]);
                else je(e, c);
            return 0 < (r = he(c, "script")).length && ge(r, !d && he(e, "script")), c
        },
    ...
    var qe, Pe, He, Me, Re, ze, Fe, We, Be = new RegExp("^(" + ee + ")(?!px)[a-z%]+$", "i"),
        Ue = function(e) {
    ...
    function Xe(e, t, n) {
        var i, o, s = e.style;
        return (n = n || Ue(e)) && ("" !== (o = n.getPropertyValue(t) || n[t]) || oe(e) || (o = k.style(e, t)), !y.pixelBoxStyles() && Be.test(o) && Qe.test(t) && (i = s.width, e = s.minWidth, t = s.maxWidth, s.minWidth = s.maxWidth = s.width = o, o = n.width, s.width = i, s.minWidth = e, s.maxWidth = t)), void 0 !== o ? o + "" : o
    }
    ...
    function Ye() {
        var e;
        We && (Fe.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0", We.style.cssText = "position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%", ie.appendChild(Fe).appendChild(We), e = C.getComputedStyle(We), qe = "1%" !== e.top, ze = 12 === Ke(e.marginLeft), We.style.right = "60%", Me = 36 === Ke(e.right), Pe = 36 === Ke(e.width), We.style.position = "absolute", He = 12 === Ke(We.offsetWidth / 3), ie.removeChild(Fe), We = null)
    }

    function Ke(e) {
        return Math.round(parseFloat(e))
    }
    Fe = x.createElement("div"), (We = x.createElement("div")).style && (We.style.backgroundClip = "content-box", We.cloneNode(!0).style.backgroundClip = "", y.clearCloneStyle = "content-box" === We.style.backgroundClip, k.extend(y, {
        ...
        reliableTrDimensions: function() {
            var e, t, n;
            return null == Re && (e = x.createElement("table"), n = x.createElement("tr"), t = x.createElement("div"), e.style.cssText = "position:absolute;left:-11111px", n.style.height = "1px", t.style.height = "9px", ie.appendChild(e).appendChild(n).appendChild(t), n = C.getComputedStyle(n), Re = 3 < parseInt(n.height), ie.removeChild(e)), Re
        }
    }));
    ...
    function et(e) {
        return k.cssProps[e] || Ze[e] || (e in Je ? e : Ze[e] = function(e) {
    ...
    function at(e, t, n) {
        ...
        return (!y.boxSizingReliable() && o || !y.reliableTrDimensions() && E(e, "tr") || "auto" === r || !parseFloat(r) && "inline" === k.css(e, "display", !1, i)) && e.getClientRects().length && (o = "border-box" === k.css(e, "boxSizing", !1, i), (s = a in e) && (r = e[a])), (r = parseFloat(r) || 0) + rt(e, t, n || (o ? "border" : "content"), s, i, r) + "px"
    }
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, s, r, a = Q(t),
                    l = nt.test(t),
                    u = e.style;
                if (l || (t = et(a)), r = k.cssHooks[t] || k.cssHooks[a], void 0 === n) return r && "get" in r && void 0 !== (o = r.get(e, !1, i)) ? o : u[t];
                "string" === (s = _typeof(n)) && (o = te.exec(n)) && o[1] && (n = ae(e, t, o), s = "number"), null != n && n == n && ("number" !== s || l || (n += o && o[3] || (k.cssNumber[a] ? "" : "px")), y.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), r && "set" in r && void 0 === (n = r.set(e, n, i)) || (l ? u.setProperty(t, n) : u[t] = n))
            }
        },
        css: function(e, t, n, i) {
            var o, s = Q(t);
            return nt.test(t) || (t = et(s)), (s = k.cssHooks[t] || k.cssHooks[s]) && "get" in s && (o = s.get(e, !0, n)), void 0 === o && (o = Xe(e, t, i)), "normal" === o && t in ot && (o = ot[t]), "" === n || n ? (t = parseFloat(o), !0 === n || isFinite(t) ? t || 0 : o) : o
        }
    }), k.each(["height", "width"], function(e, a) {
        k.cssHooks[a] = {
            get: function(e, t, n) {
                if (t) return !tt.test(k.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? at(e, a, n) : Le(e, it, function() {
                    return at(e, a, n)
                })
            },
            set: function(e, t, n) {
        ...
        css: function(e, t) {
            return F(this, function(e, t, n) {
                var i, o, s = {},
                    r = 0;
                if (Array.isArray(t)) {
                    for (i = Ue(e), o = t.length; r < o; r++) s[t[r]] = k.css(e, t[r], !1, i);
                    return s
                }
    ...
    function pt() {
        ct && (!1 === x.hidden && C.requestAnimationFrame ? C.requestAnimationFrame(pt) : C.setTimeout(pt, k.fx.interval), k.fx.tick())
    }
    ...
    function vt(o, e, t) {
        var n, s, i = 0,
            ...
            l = function() {
                if (s) return !1;
                for (var e = ut || ht(), e = Math.max(0, u.startTime + u.duration - e), t = 1 - (e / u.duration || 0), n = 0, i = u.tweens.length; n < i; n++) u.tweens[n].run(t);
            ...
            u = a.promise({
                ...
                createTween: function(e, t) {
                    e = k.Tween(o, u.opts, e, t, u.opts.specialEasing[e] || u.opts.easing);
        ...
        for (function(e, t) {
            ...
            if (n = vt.prefilters[i].call(u, o, c, u.opts)) return b(n.stop) && (k._queueHooks(u.elem, u.opts.queue).stop = n.stop.bind(n)), n;
        return k.map(c, mt, u), b(u.opts.start) && u.opts.start.call(o, u), u.progress(u.opts.progress).done(u.opts.done, u.opts.complete).fail(u.opts.fail).always(u.opts.always), k.fx.timer(k.extend(l, {
            elem: o,
            anim: u,
            queue: u.opts.queue
        })), u
    ...
    k.Animation = k.extend(vt, {
        ...
        tweener: function(e, t) {
            for (var n, i = 0, o = (e = b(e) ? (t = e, ["*"]) : e.match(L)).length; i < o; i++) n = e[i], vt.tweeners[n] = vt.tweeners[n] || [], vt.tweeners[n].unshift(t)
        },
        prefilters: [function(e, t, n) {
            ...
            for (i in n.queue || (null == (r = k._queueHooks(e, "fx")).unqueued && (r.unqueued = 0, a = r.empty.fire, r.empty.fire = function() {
                ...
                for (i in c && 1 === e.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (u = g && g.display) && (u = Y.get(e, "display")), "none" === (c = k.css(e, "display")) && (u ? c = u : (ue([e], !0), u = e.style.display || u, c = k.css(e, "display"), ue([e]))), ("inline" === c || "inline-block" === c && null != u) && "none" === k.css(e, "float") && (l || (d.done(function() {
                        p.display = u
                    }), null == u && (c = p.display, u = "none" === c ? "" : c)), p.display = "inline-block")), n.overflow && (p.overflow = "hidden", d.always(function() {
                        p.overflow = n.overflow[0], p.overflowX = n.overflow[1], p.overflowY = n.overflow[2]
                    })), l = !1, f) l || (g ? "hidden" in g && (h = g.hidden) : g = Y.access(e, "fxshow", {
                    display: u
                }), s && (g.hidden = !h), h && ue([e], !0), d.done(function() {
                    for (i in h || ue([e]), Y.remove(e, "fxshow"), f) k.style(e, i, f[i])
        ...
        stop: function(o, e, s) {
            ...
            return "string" != typeof o && (s = e, e = o, o = void 0), e && this.queue(o || "fx", []), this.each(function() {
                ...
                if (t) i[t] && i[t].stop && r(i[t]);
                    ...
                    for (t in i) i[t] && i[t].stop && ft.test(t) && r(i[t]);
    ...
    }, d = x.createElement("input"), ee = x.createElement("select").appendChild(x.createElement("option")), d.type = "checkbox", y.checkOn = "" !== d.value, y.optSelected = ee.selected, (d = x.createElement("input")).value = "t", d.type = "radio", y.radioValue = "t" === d.value;
    ...
    k.fn.extend({
            ...
            if ((e = xt(t)).length)
                for (; n = this[a++];)
                    if (r = Ct(n), i = 1 === n.nodeType && " " + Tt(r) + " ") {
                        ...
                        r !== (r = Tt(i)) && n.setAttribute("class", r)
                    } return this
        },
        ...
        toggleClass: function(o, t) {
            ...
            return "boolean" == typeof t && r ? t ? this.addClass(o) : this.removeClass(o) : b(o) ? this.each(function(e) {
                k(this).toggleClass(o.call(this, e, Ct(this), t), t)
            }) : this.each(function() {
                var e, t, n, i;
                if (r)
                    for (t = 0, n = k(this), i = xt(o); e = i[t++];) n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
                else void 0 !== o && "boolean" !== s || ((e = Ct(this)) && Y.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", !e && !1 !== o && Y.get(this, "__className__") || ""))
            })
        },
        hasClass: function(e) {
            for (var t, n = 0, i = " " + e + " "; t = this[n++];)
                if (1 === t.nodeType && -1 < (" " + Tt(Ct(t)) + " ").indexOf(i)) return !0;
            return !1
        }
    });
    var kt = /\r/g;
    ...
    k.extend(k.event, {
        trigger: function(e, t, n, i) {
            var o, s, r, a, l, u, c, d = [n || x],
                f = v.call(e, "type") ? e.type : e,
                p = v.call(e, "namespace") ? e.namespace.split(".") : [],
                h = c = s = n = n || x;
            if (3 !== n.nodeType && 8 !== n.nodeType && !Et.test(f + k.event.triggered) && (-1 < f.indexOf(".") && (f = (p = f.split(".")).shift(), p.sort()), a = f.indexOf(":") < 0 && "on" + f, (e = e[k.expando] ? e : new k.Event(f, "object" == _typeof(e) && e)).isTrigger = i ? 2 : 3, e.namespace = p.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : k.makeArray(t, [e]), u = k.event.special[f] || {}, i || !u.trigger || !1 !== u.trigger.apply(n, t))) {
                if (!i && !u.noBubble && !g(n)) {
                    for (r = u.delegateType || f, Et.test(r + f) || (h = h.parentNode); h; h = h.parentNode) d.push(h), s = h;
                    s === (n.ownerDocument || x) && d.push(s.defaultView || s.parentWindow || C)
                }
                for (o = 0;
                    (h = d[o++]) && !e.isPropagationStopped();) c = h, e.type = 1 < o ? r : u.bindType || f, (l = (Y.get(h, "events") || Object.create(null))[e.type] && Y.get(h, "handle")) && l.apply(h, t), (l = a && h[a]) && l.apply && X(h) && (e.result = l.apply(h, t), !1 === e.result && e.preventDefault());
                return e.type = f, i || e.isDefaultPrevented() || u._default && !1 !== u._default.apply(d.pop(), t) || !X(n) || a && b(n[f]) && !g(n) && ((s = n[a]) && (n[a] = null), k.event.triggered = f, e.isPropagationStopped() && c.addEventListener(f, St), n[f](), e.isPropagationStopped() && c.removeEventListener(f, St), k.event.triggered = void 0, s && (n[a] = s)), e.result
            }
        },
    ...
    k.param = function(e, t) {
        ...
        if (Array.isArray(e) || e.jquery && !k.isPlainObject(e)) k.each(e, function() {
            ...
            for (i in e) ! function n(i, e, o, s) {
                if (Array.isArray(e)) k.each(e, function(e, t) {
                    o || Nt.test(i) ? s(i, t) : n(i + "[" + ("object" == _typeof(t) && null != t ? e : "") + "]", t, o, s)
                });
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !k(this).is(":disabled") && It.test(this.nodeName) && !Ot.test(e) && (this.checked || !ce.test(e))
            }).map(function(e, t) {
                var n = k(this).val();
    ...
    Bt.href = At.href, k.extend({
        ...
        ajax: function(e, t) {
            ...
            var l, u, c, n, d, i, f, p, o, s, h = k.ajaxSetup({}, t),
                g = h.context || h,
                ...
                _ = {
                    ...
                    getResponseHeader: function(e) {
                        ...
                        if (f) {
                            if (!n)
                                for (n = {}; t = Ht.exec(c);) n[t[1].toLowerCase() + " "] = (n[t[1].toLowerCase() + " "] || []).concat(t[2]);
                            t = n[e.toLowerCase() + " "]
                        }
            ...
            if (v.promise(_), h.url = ((e || h.url || At.href) + "").replace(Rt, At.protocol + "//"), h.type = t.method || t.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(L) || [""], null == h.crossDomain) {
                i = x.createElement("a");
                try {
            ...
            if (h.data && h.processData && "string" != typeof h.data && (h.data = k.param(h.data, h.traditional)), Qt(zt, h, t, _), f) return _;
            for (o in (p = k.event && h.global) && 0 == k.active++ && k.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Mt.test(h.type), u = h.url.replace(qt, ""), h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Lt, "+")) : (s = h.url.slice(u.length), h.data && (h.processData || "string" == typeof h.data) && (u += (Dt.test(u) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (u = u.replace(Pt, "$1"), s = (Dt.test(u) ? "&" : "?") + "_=" + $t.guid++ + s), h.url = u + s), h.ifModified && (k.lastModified[u] && _.setRequestHeader("If-Modified-Since", k.lastModified[u]), k.etag[u] && _.setRequestHeader("If-None-Match", k.etag[u])), (h.data && h.hasContent && !1 !== h.contentType || t.contentType) && _.setRequestHeader("Content-Type", h.contentType), _.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Wt + "; q=0.01" : "") : h.accepts["*"]), h.headers) _.setRequestHeader(o, h.headers[o]);
            if (h.beforeSend && (!1 === h.beforeSend.call(g, _, h) || f)) return _.abort();
            if (w = "abort", y.add(h.complete), _.done(h.success), _.fail(h.error), l = Qt(Ft, h, t, _)) {
                if (_.readyState = 1, p && m.trigger("ajaxSend", [_, h]), f) return _;
                h.async && 0 < h.timeout && (d = C.setTimeout(function() {
                    _.abort("timeout")
                }, h.timeout));
                try {
                    f = !1, l.send(r, T)
            ...
            function T(e, t, n, i) {
                var o, s, r, a = t;
                f || (f = !0, d && C.clearTimeout(d), l = void 0, c = i || "", _.readyState = 0 < e ? 4 : 0, i = 200 <= e && e < 300 || 304 === e, n && (r = function(e, t, n) {
                ...
                }(h, _, n)), !i && -1 < k.inArray("script", h.dataTypes) && (h.converters["text script"] = function() {}), r = function(e, t, n, i) {
                    var o, s, r, a, l, u = {},
                        c = e.dataTypes.slice();
                    if (c[1])
                ...
                }(h, r, _, i), i ? (h.ifModified && ((n = _.getResponseHeader("Last-Modified")) && (k.lastModified[u] = n), (n = _.getResponseHeader("etag")) && (k.etag[u] = n)), 204 === e || "HEAD" === h.type ? a = "nocontent" : 304 === e ? a = "notmodified" : (a = r.state, o = r.data, i = !(s = r.error))) : (s = a, !e && a || (a = "error", e < 0 && (e = 0))), _.status = e, _.statusText = (t || a) + "", i ? v.resolveWith(g, [o, a, _]) : v.rejectWith(g, [_, a, s]), _.statusCode(b), b = void 0, p && m.trigger(i ? "ajaxSuccess" : "ajaxError", [_, h, i ? o : s]), y.fireWith(g, [_, a]), p && (m.trigger("ajaxComplete", [_, h]), --k.active || k.event.trigger("ajaxStop")))
            }
            return _
        },
    ...
    y.cors = !!Yt && "withCredentials" in Yt, y.ajax = Yt = !!Yt, k.ajaxTransport(function(o) {
        var s, r;
        if (y.cors || Yt && !o.crossDomain) return {
            send: function(e, t) {
                var n, i = o.xhr();
                ...
                s = function(e) {
                    return function() {
                        s && (s = r = i.onload = i.onerror = i.onabort = i.ontimeout = i.onreadystatechange = null, "abort" === e ? i.abort() : "error" === e ? "number" != typeof i.status ? t(0, "error") : t(i.status, i.statusText) : t(Vt[i.status] || i.status, i.statusText, "text" !== (i.responseType || "text") || "string" != typeof i.responseText ? {
                            binary: i.response
                        } : {
                            text: i.responseText
    ...
    k.ajaxSetup({
        ...
        if (r || "jsonp" === e.dataTypes[0]) return i = e.jsonpCallback = b(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, r ? e[r] = e[r].replace(Gt, "$1" + i) : !1 !== e.jsonp && (e.url += (Dt.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function() {
            return s || k.error(i + " was not called"), s[0]
        }, e.dataTypes[0] = "json", o = C[i], C[i] = function() {
            s = arguments
        }, n.always(function() {
            void 0 === o ? k(C).removeProp(i) : C[i] = o, e[i] && (e.jsonpCallback = t.jsonpCallback, Kt.push(i)), s && b(o) && o(s[0]), s = o = void 0
        }), "script"
    }), y.createHTMLDocument = ((d = x.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === d.childNodes.length), k.parseHTML = function(e, t, n) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (y.createHTMLDocument ? ((i = (t = x.implementation.createHTMLDocument("")).createElement("base")).href = x.location.href, t.head.appendChild(i)) : t = x), i = !n && [], (n = A.exec(e)) ? [t.createElement(n[1])] : (n = ve([e], t, i), i && i.length && k(i).remove(), k.merge([], n.childNodes)));
        var i
    }, k.fn.load = function(e, t, n) {
        var i, o, s, r = this,
            a = e.indexOf(" ");
        return -1 < a && (i = Tt(e.slice(a)), e = e.slice(0, a)), b(t) ? (n = t, t = void 0) : t && "object" == _typeof(t) && (o = "POST"), 0 < r.length && k.ajax({
            url: e,
            type: o || "GET",
            dataType: "html",
            data: t
        ...
        setOffset: function(e, t, n) {
            var i, o, s, r, a = k.css(e, "position"),
                l = k(e),
                u = {};
            "static" === a && (e.style.position = "relative"), s = l.offset(), i = k.css(e, "top"), r = k.css(e, "left"), r = ("absolute" === a || "fixed" === a) && -1 < (i + r).indexOf("auto") ? (o = (a = l.position()).top, a.left) : (o = parseFloat(i) || 0, parseFloat(r) || 0), b(t) && (t = t.call(e, n, k.extend({}, s))), null != t.top && (u.top = t.top - s.top + o), null != t.left && (u.left = t.left - s.left + r), "using" in t ? t.using.call(e, u) : ("number" == typeof u.top && (u.top += "px"), "number" == typeof u.left && (u.left += "px"), l.css(u))
        }
    }, k.fn.extend({
        offset: function(t) {
        ...
        k.cssHooks[n] = Ve(y.pixelPosition, function(e, t) {
    ...
    }, k.isArray = Array.isArray, k.parseJSON = JSON.parse, k.nodeName = E, k.isFunction = b, k.isWindow = g, k.camelCase = Q, k.type = h, k.now = Date.now, k.isNumeric = function(e) {
        var t = k.type(e);
...
function(e, t) {
        ...
        typeCheckConfig: function(e, t, n) {
            for (var i in n)
                if (Object.prototype.hasOwnProperty.call(n, i)) {
                    var o = n[i],
                        s = t[i],
                        s = s && d.isElement(s) ? "element" : null === s || void 0 === s ? "" + s : {}.toString.call(s).match(/\s([a-z]+)/i)[1].toLowerCase();
    ...
    var l = "alert",
        u = c.default.fn[l],
        f = ((n = p.prototype).close = function(e) {
            var t = this._element;
            ...
            return this.each(function() {
                var e = c.default(this),
                    t = e.data("bs.alert");
                t || (t = new p(this), e.data("bs.alert", t)), "close" === n && t[n](this)
            })
    ...
    c.default(document).on("click.bs.alert.data-api", '[data-dismiss="alert"]', f._handleDismiss(new f)), c.default.fn[l] = f._jQueryInterface, c.default.fn[l].Constructor = f, c.default.fn[l].noConflict = function() {
        return c.default.fn[l] = u, f._jQueryInterface
    };
    var h = c.default.fn.button,
        g = ((n = m.prototype).toggle = function() {
            var e, t = !0,
                n = !0,
            ...
            return this.each(function() {
                var e = c.default(this),
                    t = e.data("bs.button");
                t || (t = new m(this), e.data("bs.button", t)), t.shouldAvoidTriggerChange = i, "toggle" === n && t[n]()
            })
        }, r(m, null, [{
            key: "VERSION",
            get: function() {
    ...
    }), c.default.fn.button = g._jQueryInterface, c.default.fn.button.Constructor = g, c.default.fn.button.noConflict = function() {
        return c.default.fn.button = h, g._jQueryInterface
    };
    var v = "carousel",
        y = c.default.fn[v],
        b = {
        ...
        T = ((n = C.prototype).next = function() {
            ...
            this._touchSupported && (e = function(e) {
                n._pointerEvent && _[e.originalEvent.pointerType.toUpperCase()] ? n.touchStartX = e.originalEvent.clientX : n._pointerEvent || (n.touchStartX = e.originalEvent.touches[0].clientX)
            }, t = function(e) {
                n._pointerEvent && _[e.originalEvent.pointerType.toUpperCase()] && (n.touchDeltaX = e.originalEvent.clientX - n.touchStartX), n._handleSwipe(), "hover" === n._config.pause && (n.pause(), n.touchTimeout && clearTimeout(n.touchTimeout), n.touchTimeout = setTimeout(function(e) {
                    return n.cycle(e)
            ...
            var t;
            this._indicatorsElement && (t = [].slice.call(this._indicatorsElement.querySelectorAll(".active")), c.default(t).removeClass("active"), (e = this._indicatorsElement.children[this._getItemIndex(e)]) && c.default(e).addClass("active"))
            ...
            l && c.default(l).hasClass("active") ? this._isSliding = !1 : !this._triggerSlideEvent(l, e).isDefaultPrevented() && r && l && (this._isSliding = !0, t && this.pause(), this._setActiveIndicatorElement(l), o = c.default.Event("slid.bs.carousel", {
                relatedTarget: l,
                direction: e,
                from: a,
                to: u
            }), c.default(this._element).hasClass("slide") ? (c.default(l).addClass(i), d.reflow(l), c.default(r).addClass(n), c.default(l).addClass(n), (u = parseInt(l.getAttribute("data-interval"), 10)) ? (this._config.defaultInterval = this._config.defaultInterval || this._config.interval, this._config.interval = u) : this._config.interval = this._config.defaultInterval || this._config.interval, u = d.getTransitionDurationFromElement(r), c.default(r).one(d.TRANSITION_END, function() {
                c.default(l).removeClass(n + " " + i).addClass("active"), c.default(r).removeClass("active " + i + " " + n), s._isSliding = !1, setTimeout(function() {
                    return c.default(s._element).trigger(o)
                }, 0)
            }).emulateTransitionEnd(u)) : (c.default(r).removeClass("active"), c.default(l).addClass("active"), this._isSliding = !1, c.default(this._element).trigger(o)), t && this.cycle())
        }, C._jQueryInterface = function(i) {
            return this.each(function() {
                var e = c.default(this).data("bs.carousel"),
                    t = a({}, b, c.default(this).data());
                "object" == _typeof(i) && (t = a({}, t, i));
                var n = "string" == typeof i ? i : t.slide;
                if (e || (e = new C(this, t), c.default(this).data("bs.carousel", e)), "number" == typeof i) e.to(i);
            ...
            !i || (t = c.default(i)[0]) && c.default(t).hasClass("carousel") && (n = a({}, c.default(t).data(), c.default(this).data()), (i = this.getAttribute("data-slide-to")) && (n.interval = !1), C._jQueryInterface.call(c.default(t), n), i && c.default(t).data("bs.carousel").to(i), e.preventDefault())
        }, r(C, null, [{
            key: "VERSION",
            get: function() {
                return "4.5.3"
    ...
    c.default(document).on("click.bs.carousel.data-api", "[data-slide], [data-slide-to]", T._dataApiClickHandler), c.default(window).on("load.bs.carousel.data-api", function() {
        for (var e = [].slice.call(document.querySelectorAll('[data-ride="carousel"]')), t = 0, n = e.length; t < n; t++) {
            var i = c.default(e[t]);
            T._jQueryInterface.call(i, i.data())
        }
    }), c.default.fn[v] = T._jQueryInterface, c.default.fn[v].Constructor = T, c.default.fn[v].noConflict = function() {
        return c.default.fn[v] = y, T._jQueryInterface
    };
    var x = "collapse",
        k = c.default.fn[x],
        S = {
        ...
        A = ((n = $.prototype).toggle = function() {
            c.default(this._element).hasClass("show") ? this.hide() : this.show()
        }, n.show = function() {
            var e, t, n, i, o = this;
            this._isTransitioning || c.default(this._element).hasClass("show") || (this._parent && 0 === (i = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function(e) {
                ...
                c.default(o._element).removeClass("collapsing").addClass("collapse show"), o._element.style[t] = "", o.setTransitioning(!1), c.default(o._element).trigger("shown.bs.collapse")
            ...
            if (!this._isTransitioning && c.default(this._element).hasClass("show")) {
                ...
                if (c.default(this._element).trigger(t), !t.isDefaultPrevented()) {
                    ...
                    this._element.style[t] = this._element.getBoundingClientRect()[t] + "px", d.reflow(this._element), c.default(this._element).addClass("collapsing").removeClass("collapse show");
                    var n = this._triggerArray.length;
                    if (0 < n)
                        for (var i = 0; i < n; i++) {
                            var o = this._triggerArray[i],
                                s = d.getSelectorFromElement(o);
                            null !== s && (c.default([].slice.call(document.querySelectorAll(s))).hasClass("show") || c.default(o).addClass("collapsed").attr("aria-expanded", !1))
                        }
                    this.setTransitioning(!0), this._element.style[t] = "";
                    t = d.getTransitionDurationFromElement(this._element);
                    c.default(this._element).one(d.TRANSITION_END, function() {
                        e.setTransitioning(!1), c.default(e._element).removeClass("collapsing").addClass("collapse").trigger("hidden.bs.collapse")
            ...
            return (e = a({}, S, e)).toggle = Boolean(e.toggle), d.typeCheckConfig(x, e, E), e
            ...
            return c.default(t).each(function(e, t) {
                n._addAriaAndCollapsedClass($._getTargetFromElement(t), [t])
            }), e
            ...
            return this.each(function() {
                var e = c.default(this),
                    ...
                    n = a({}, S, e.data(), "object" == _typeof(i) && i ? i : {});
                if (!t && n.toggle && "string" == typeof i && /show|hide/.test(i) && (n.toggle = !1), t || (t = new $(this, n), e.data("bs.collapse", t)), "string" == typeof i) {
    ...
    }), c.default.fn[x] = A._jQueryInterface, c.default.fn[x].Constructor = A, c.default.fn[x].noConflict = function() {
        return c.default.fn[x] = k, A._jQueryInterface
    };
    var D = "dropdown",
        N = c.default.fn[D],
        ...
        L = ((n = q.prototype).toggle = function() {
            var e;
            this._element.disabled || c.default(this._element).hasClass("disabled") || (e = c.default(this._menu).hasClass("show"), q._clearMenus(), e || this.show(!0))
        }, n.show = function(e) {
            if (void 0 === e && (e = !1), !(this._element.disabled || c.default(this._element).hasClass("disabled") || c.default(this._menu).hasClass("show"))) {
                ...
                if (c.default(i).trigger(n), !n.isDefaultPrevented()) {
                    if (!this._inNavbar && e) {
                        ...
                        e = this._element;
                        "parent" === this._config.reference ? e = i : d.isElement(this._config.reference) && (e = this._config.reference, void 0 !== this._config.reference.jquery && (e = this._config.reference[0])), "scrollParent" !== this._config.boundary && c.default(i).addClass("position-static"), this._popper = new o.default(e, this._menu, this._getPopperConfig())
                    }
            ...
            this._element.disabled || c.default(this._element).hasClass("disabled") || !c.default(this._menu).hasClass("show") || (e = {
                relatedTarget: this._element
            }, t = c.default.Event("hide.bs.dropdown", e), n = q._getParentFromElement(this._element), c.default(n).trigger(t), t.isDefaultPrevented() || (this._popper && this._popper.destroy(), c.default(this._menu).toggleClass("show"), c.default(n).toggleClass("show").trigger(c.default.Event("hidden.bs.dropdown", e))))
        }, n.dispose = function() {
            ...
            return e = a({}, this.constructor.Default, c.default(this._element).data(), e), d.typeCheckConfig(D, e, this.constructor.DefaultType), e
            ...
            var e = c.default(this._element.parentNode),
                t = "bottom-start";
            return e.hasClass("dropup") ? t = c.default(this._menu).hasClass("dropdown-menu-right") ? "top-end" : "top-start" : e.hasClass("dropright") ? t = "right-start" : e.hasClass("dropleft") ? t = "left-start" : c.default(this._menu).hasClass("dropdown-menu-right") && (t = "bottom-end"), t
            ...
            return this.each(function() {
                ...
                if (e || (e = new q(this, "object" == _typeof(t) ? t : null), c.default(this).data("bs.dropdown", e)), "string" == typeof t) {
            ...
            if (!e || 3 !== e.which && ("keyup" !== e.type || 9 === e.which))
                for (var t = [].slice.call(document.querySelectorAll('[data-toggle="dropdown"]')), n = 0, i = t.length; n < i; n++) {
                    var o, s, r = q._getParentFromElement(t[n]),
                        a = c.default(t[n]).data("bs.dropdown"),
                        l = {
                            relatedTarget: t[n]
                        };
            ...
            if (!(/input|textarea/i.test(e.target.tagName) ? 32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || c.default(e.target).closest(".dropdown-menu").length) : !j.test(e.which)) && !this.disabled && !c.default(this).hasClass("disabled")) {
                var t = q._getParentFromElement(this),
                    n = c.default(t).hasClass("show");
                if (n || 27 !== e.which) {
                    if (e.preventDefault(), e.stopPropagation(), !n || 27 === e.which || 32 === e.which) return 27 === e.which && c.default(t.querySelector('[data-toggle="dropdown"]')).trigger("focus"), void c.default(this).trigger("click");
    ...
    c.default(document).on("keydown.bs.dropdown.data-api", '[data-toggle="dropdown"]', L._dataApiKeydownHandler).on("keydown.bs.dropdown.data-api", ".dropdown-menu", L._dataApiKeydownHandler).on("click.bs.dropdown.data-api keyup.bs.dropdown.data-api", L._clearMenus).on("click.bs.dropdown.data-api", '[data-toggle="dropdown"]', function(e) {
        e.preventDefault(), e.stopPropagation(), L._jQueryInterface.call(c.default(this), "toggle")
    }).on("click.bs.dropdown.data-api", ".dropdown form", function(e) {
        e.stopPropagation()
    }), c.default.fn[D] = L._jQueryInterface, c.default.fn[D].Constructor = L, c.default.fn[D].noConflict = function() {
        return c.default.fn[D] = N, L._jQueryInterface
    };
    var P = c.default.fn.modal,
        H = {
            backdrop: !0,
            keyboard: !0,
            focus: !0,
        ...
        R = ((n = z.prototype).toggle = function(e) {
            return this._isShown ? this.hide() : this.show(e)
        }, n.show = function(e) {
            var t, n = this;
            this._isShown || this._isTransitioning || (c.default(this._element).hasClass("fade") && (this._isTransitioning = !0), t = c.default.Event("show.bs.modal", {
                relatedTarget: e
            }), c.default(this._element).trigger(t), this._isShown || t.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), c.default(this._element).on("click.dismiss.bs.modal", '[data-dismiss="modal"]', function(e) {
                return n.hide(e)
            ...
            var t = this,
                n = c.default(this._element).hasClass("fade"),
            ...
            var o = c.default.Event("shown.bs.modal", {
                ...
                e = function() {
                    t._config.focus && t._element.focus(), t._isTransitioning = !1, c.default(t._element).trigger(o)
                };
            ...
            this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._isTransitioning = !1, this._showBackdrop(function() {
                c.default(document.body).removeClass("modal-open"), e._resetAdjustments(), e._resetScrollbar(), c.default(e._element).trigger("hidden.bs.modal")
            })
            ...
            this._isShown && this._config.backdrop ? (this._backdrop = document.createElement("div"), this._backdrop.className = "modal-backdrop", i && this._backdrop.classList.add(i), c.default(this._backdrop).appendTo(document.body), c.default(this._element).on("click.dismiss.bs.modal", function(e) {
                n._ignoreBackdropClick ? n._ignoreBackdropClick = !1 : e.target === e.currentTarget && n._triggerBackdropTransition()
            }), i && d.reflow(this._backdrop), c.default(this._backdrop).addClass("show"), e && (i ? (t = d.getTransitionDurationFromElement(this._backdrop), c.default(this._backdrop).one(d.TRANSITION_END, e).emulateTransitionEnd(t)) : e())) : !this._isShown && this._backdrop ? (c.default(this._backdrop).removeClass("show"), i = function() {
                n._removeBackdrop(), e && e()
            }, c.default(this._element).hasClass("fade") ? (t = d.getTransitionDurationFromElement(this._backdrop), c.default(this._backdrop).one(d.TRANSITION_END, i).emulateTransitionEnd(t)) : i()) : e && e()
            ...
            var e, t, o = this;
            this._isBodyOverflowing && (e = [].slice.call(document.querySelectorAll(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top")), t = [].slice.call(document.querySelectorAll(".sticky-top")), c.default(e).each(function(e, t) {
            ...
            }), e = document.body.style.paddingRight, t = c.default(document.body).css("padding-right"), c.default(document.body).data("padding-right", e).css("padding-right", parseFloat(t) + this._scrollbarWidth + "px")), c.default(document.body).addClass("modal-open")
        ...
        }, z._jQueryInterface = function(n, i) {
            return this.each(function() {
                var e = c.default(this).data("bs.modal"),
                    t = a({}, H, c.default(this).data(), "object" == _typeof(n) && n ? n : {});
                if (e || (e = new z(this, t), c.default(this).data("bs.modal", e)), "string" == typeof n) {
                    if (void 0 === e[n]) throw new TypeError('No method named "' + n + '"');
                    e[n](i)
    ...
    c.default(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', function(e) {
        ...
        i = c.default(t).data("bs.modal") ? "toggle" : a({}, c.default(t).data(), c.default(this).data());
        "A" !== this.tagName && "AREA" !== this.tagName || e.preventDefault();
        var o = c.default(t).one("show.bs.modal", function(e) {
            e.isDefaultPrevented() || o.one("hidden.bs.modal", function() {
                c.default(n).is(":visible") && n.focus()
            })
        });
        R._jQueryInterface.call(c.default(t), i, this)
    }), c.default.fn.modal = R._jQueryInterface, c.default.fn.modal.Constructor = R, c.default.fn.modal.noConflict = function() {
        return c.default.fn.modal = P, R._jQueryInterface
    };
    ...
    function U(e, o, t) {
        ...
        for (var e = (new window.DOMParser).parseFromString(e, "text/html"), s = Object.keys(o), r = [].slice.call(e.body.querySelectorAll("*")), n = 0, i = r.length; n < i; n++) ! function(e) {
            var t = r[e],
            ...
            e.forEach(function(e) {
                ! function(e, t) {
                    ...
                    if (-1 !== t.indexOf(n)) return -1 === F.indexOf(n) || Boolean(e.nodeValue.match(W) || e.nodeValue.match(B));
    ...
    var Q = "tooltip",
        ...
        ee = ((n = te.prototype).enable = function() {
            this._isEnabled = !0
        }, n.disable = function() {
            this._isEnabled = !1
            ...
            }, c.default(this.tip).hasClass("fade") ? (n = d.getTransitionDurationFromElement(this.tip), c.default(this.tip).one(d.TRANSITION_END, i).emulateTransitionEnd(n)) : i()))
        }, n.hide = function(e) {
            function t() {
                "show" !== n._hoverState && i.parentNode && i.parentNode.removeChild(i), n._cleanTipClass(), n.element.removeAttribute("aria-describedby"), c.default(n.element).trigger(n.constructor.Event.HIDDEN), null !== n._popper && n._popper.destroy(), e && e()
            }
            var n = this,
                i = this.getTipElement(),
                o = c.default.Event(this.constructor.Event.HIDE);
            c.default(this.element).trigger(o), o.isDefaultPrevented() || (c.default(i).removeClass("show"), "ontouchstart" in document.documentElement && c.default(document.body).children().off("mouseover", null, c.default.noop), this._activeTrigger.click = !1, this._activeTrigger.focus = !1, this._activeTrigger.hover = !1, c.default(this.tip).hasClass("fade") ? (o = d.getTransitionDurationFromElement(i), c.default(i).one(d.TRANSITION_END, t).emulateTransitionEnd(o)) : t(), this._hoverState = "")
        }, n.update = function() {
            ...
            "object" != _typeof(t) || !t.nodeType && !t.jquery ? this.config.html ? (this.config.sanitize && (t = U(t, this.config.whiteList, this.config.sanitizeFn)), e.html(t)) : e.text(t) : this.config.html ? c.default(t).parent().is(e) || e.empty().append(t) : e.text(c.default(t).text())
        }, n.getTitle = function() {
            ...
            this.config.trigger.split(" ").forEach(function(e) {
                ...
                "click" === e ? c.default(n.element).on(n.constructor.Event.CLICK, n.config.selector, function(e) {
                    return n.toggle(e)
                }) : "manual" !== e && (t = "hover" === e ? n.constructor.Event.MOUSEENTER : n.constructor.Event.FOCUSIN, e = "hover" === e ? n.constructor.Event.MOUSELEAVE : n.constructor.Event.FOCUSOUT, c.default(n.element).on(t, n.config.selector, function(e) {
                    return n._enter(e)
                ...
                n.element && n.hide()
            }, c.default(this.element).closest(".modal").on("hide.bs.modal", this._hideModalHandler), this.config.selector ? this.config = a({}, this.config, {
                trigger: "manual",
                selector: ""
            }) : this._fixTitle()
            ...
            return Object.keys(t).forEach(function(e) {
                ...
                show: e.delay,
                hide: e.delay
            }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), d.typeCheckConfig(Q, e, this.constructor.DefaultType), e.sanitize && (e.template = U(e.template, e.whiteList, e.sanitizeFn)), e
            ...
            null === e.getAttribute("x-placement") && (c.default(e).removeClass("fade"), this.config.animation = !1, this.hide(), this.show(), this.config.animation = t)
        }, te._jQueryInterface = function(i) {
            return this.each(function() {
                var e = c.default(this),
                    t = e.data("bs.tooltip"),
                    n = "object" == _typeof(i) && i;
                if ((t || !/dispose|hide/.test(i)) && (t || (t = new te(this, n), e.data("bs.tooltip", t)), "string" == typeof i)) {
                    if (void 0 === t[i]) throw new TypeError('No method named "' + i + '"');
                    t[i]()
                }
            })
    ...
    c.default.fn[Q] = ee._jQueryInterface, c.default.fn[Q].Constructor = ee, c.default.fn[Q].noConflict = function() {
        return c.default.fn[Q] = X, ee._jQueryInterface
    };
    var ne = "popover",
        ie = c.default.fn[ne],
        ...
        le = function(e) {
            ...
            return n.isWithContent = function() {
                ...
                return this.each(function() {
                    ...
                    if ((e || !/dispose|hide/.test(n)) && (e || (e = new i(this, t), c.default(this).data("bs.popover", e)), "string" == typeof n)) {
                        if (void 0 === e[n]) throw new TypeError('No method named "' + n + '"');
                        e[n]()
                    }
                })
    ...
    c.default.fn[ne] = le._jQueryInterface, c.default.fn[ne].Constructor = le, c.default.fn[ne].noConflict = function() {
        return c.default.fn[ne] = ie, le._jQueryInterface
    };
    var ue = "scrollspy",
        ce = c.default.fn[ue],
        de = {
        ...
        pe = ((n = he.prototype).refresh = function() {
            var t = this,
            ...
            this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), [].slice.call(document.querySelectorAll(this._selector)).map(function(e) {
                ...
                if (n && (t = document.querySelector(n)), t) {
                    ...
                    if (e.width || e.height) return [c.default(t)[i]().top + o, n]
                }
                return null
            }).filter(function(e) {
                return e
            ...
            var t;
            return "string" != typeof(e = a({}, de, "object" == _typeof(e) && e ? e : {})).target && d.isElement(e.target) && ((t = c.default(e.target).attr("id")) || (t = d.getUID(ue), c.default(e.target).attr("id", t)), e.target = "#" + t), d.typeCheckConfig(ue, e, fe), e
            ...
            return this.each(function() {
                ...
                if (e || (e = new he(this, "object" == _typeof(t) && t), c.default(this).data("bs.scrollspy", e)), "string" == typeof t) {
                    if (void 0 === e[t]) throw new TypeError('No method named "' + t + '"');
                    e[t]()
                }
            })
    ...
    }), c.default.fn[ue] = pe._jQueryInterface, c.default.fn[ue].Constructor = pe, c.default.fn[ue].noConflict = function() {
        return c.default.fn[ue] = ce, pe._jQueryInterface
    };
    var ge = c.default.fn.tab,
        me = ((n = ve.prototype).show = function() {
            ...
            this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && c.default(this._element).hasClass("active") || c.default(this._element).hasClass("disabled") || (s = c.default(this._element).closest(".nav, .list-group")[0], t = d.getSelectorFromElement(this._element), s && (o = "UL" === s.nodeName || "OL" === s.nodeName ? "> li > .active" : ".active", n = (n = c.default.makeArray(c.default(s).find(o)))[n.length - 1]), i = c.default.Event("hide.bs.tab", {
                ...
                relatedTarget: n
            }), n && c.default(n).trigger(i), c.default(this._element).trigger(o), o.isDefaultPrevented() || i.isDefaultPrevented() || (t && (e = document.querySelector(t)), this._activate(this._element, s), s = function() {
            ...
            var i = this,
                o = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? c.default(t).children(".active") : c.default(t).find("> li > .active"))[0],
                s = n && o && c.default(o).hasClass("fade"),
                t = function() {
                    return i._transitionComplete(e, o, n)
                };
            o && s ? (s = d.getTransitionDurationFromElement(o), c.default(o).removeClass("show").one(d.TRANSITION_END, t).emulateTransitionEnd(s)) : t()
        }, n._transitionComplete = function(e, t, n) {
            var i;
            t && (c.default(t).removeClass("active"), (i = c.default(t.parentNode).find("> .dropdown-menu .active")[0]) && c.default(i).removeClass("active"), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !1)), c.default(e).addClass("active"), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), d.reflow(e), e.classList.contains("fade") && e.classList.add("show"), e.parentNode && c.default(e.parentNode).hasClass("dropdown-menu") && ((t = c.default(e).closest(".dropdown")[0]) && (t = [].slice.call(t.querySelectorAll(".dropdown-toggle")), c.default(t).addClass("active")), e.setAttribute("aria-expanded", !0)), n && n()
        }, ve._jQueryInterface = function(n) {
            return this.each(function() {
                var e = c.default(this),
                    t = e.data("bs.tab");
                if (t || (t = new ve(this), e.data("bs.tab", t)), "string" == typeof n) {
    ...
    c.default(document).on("click.bs.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(e) {
        e.preventDefault(), me._jQueryInterface.call(c.default(this), "show")
    }), c.default.fn.tab = me._jQueryInterface, c.default.fn.tab.Constructor = me, c.default.fn.tab.noConflict = function() {
        return c.default.fn.tab = ge, me._jQueryInterface
    };
    var ye = c.default.fn.toast,
        be = {
            animation: "boolean",
            autohide: "boolean",
            delay: "number"
        ...
        _e = ((n = Te.prototype).show = function() {
            var e, t = this,
            ...
            }, this._element.classList.remove("hide"), d.reflow(this._element), this._element.classList.add("showing"), this._config.animation ? (n = d.getTransitionDurationFromElement(this._element), c.default(this._element).one(d.TRANSITION_END, e).emulateTransitionEnd(n)) : e())
        }, n.hide = function() {
            var e;
            this._element.classList.contains("show") && (e = c.default.Event("hide.bs.toast"), c.default(this._element).trigger(e), e.isDefaultPrevented() || this._close())
        }, n.dispose = function() {
            ...
            return e = a({}, we, c.default(this._element).data(), "object" == _typeof(e) && e ? e : {}), d.typeCheckConfig("toast", e, this.constructor.DefaultType), e
        }, n._setListeners = function() {
            var e = this;
            ...
            var t, n = this;
            this._element.classList.remove("show"), this._config.animation ? (t = d.getTransitionDurationFromElement(this._element), c.default(this._element).one(d.TRANSITION_END, e).emulateTransitionEnd(t)) : e()
            ...
            return this.each(function() {
                var e = c.default(this),
                    t = e.data("bs.toast");
                if (t || (t = new Te(this, "object" == _typeof(n) && n), e.data("bs.toast", t)), "string" == typeof n) {
                    if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
                    t[n](this)
                }
            })
    ...
    c.default.fn.toast = _e._jQueryInterface, c.default.fn.toast.Constructor = _e, c.default.fn.toast.noConflict = function() {
        return c.default.fn.toast = ye, _e._jQueryInterface
    }, e.Alert = f, e.Button = g, e.Carousel = T, e.Collapse = A, e.Dropdown = L, e.Modal = R, e.Popover = le, e.Scrollspy = pe, e.Tab = me, e.Toast = _e, e.Tooltip = ee, e.Util = d, Object.defineProperty(e, "__esModule", {
        value: !0
    })
}),
function(e) {
    ...
    i = 0, (r = function(e, t) {
        ...
        var e, t, n, i, o, s = this,
            r = !1;
        if ("object" === u.type(arguments[0]) ? (n = arguments[0], r = arguments[1], o = "multiple") : "string" === u.type(arguments[0]) && (i = arguments[1], r = arguments[2], "responsive" === (n = arguments[0]) && "array" === u.type(arguments[1]) ? o = "responsive" : void 0 !== arguments[1] && (o = "single")), "single" === o) s.options[n] = i;
        ...
        for (var e, t = this, n = arguments[0], i = Array.prototype.slice.call(arguments, 1), o = t.length, s = 0; s < o; s++)
            if ("object" == _typeof(n) || void 0 === n ? t[s].slick = new r(t[s], n) : e = t[s].slick[n].apply(t[s].slick, i), void 0 !== e) return e;
        return t
    }
});
var carouselContent = {
        familles: {
            "carousel-main-title": "Transmettre la joie des fêtes<br><span>aux familles touchées par la précarité</span>",
            "carousel-main-text": "«&nbsp;Je suis au RSA, sans emploi et j'élève seule mes deux enfants. Sans l'association, nous n'aurions pas pu fêter Noël, cette année je n'avais pas de quoi organiser une fête. Cette soirée est vraiment un beau souvenir pour les enfants, c'était un moment plein de joie... Ma plus grande fille était tellement contente de son cadeau, que cela m'a mis du baume au cœur. On s'est sentis entourés et à ce moment de l'année on en avait vraiment besoin...&nbsp;».",
            "carousel-signature": "Marie, maman de 2 enfants",
            "carousel-second-text": "Chaque année, nous allons à la rencontre des familles démunies. Grâce aux dons que nous recevons, nous leur portons des colis alimentaires, des vêtements, des jouets… Et les invitons à des moments de fête pour rompre leur isolement, notamment à Noël.",
            value: 0,
            icon: "/noelfraternel/dist/asset/img/family-title.svg"
        },
        personnesalarue: {
            "carousel-main-title": "Tendre la main<br><span>aux plus démunis</span>",
            "carousel-main-text": "«&nbsp;Les bénévoles m'ont invité au réveillon de l'association au cours d'une maraude.  Je vis à la rue et c’est vrai que ça m'a fait chaud au cœur. On a beau s'habituer à la solitude, les fêtes de fin d'année c’est toujours plus compliqué. Grâce à eux, j'ai passé un joli moment. Je me suis sentie considérée, soutenue. Je ne les remercierais jamais assez pour tout ce qu'ils font.&nbsp;».",
            "carousel-signature": "Sophie, sans-abri",
            "carousel-second-text": "Chaque année, nous effectuons 10 000 tournées pour visiter les personnes qui sont dans la rue. 600 000 personnes sont accueillies dans nos locaux et nous offrons 166 000 nuitées en hébergement d'urgence. Votre don contribue à aider une personne à sortir de la rue.",
            value: 1,
            icon: "/noelfraternel/dist/asset/img/street.svg"
        },
        personnesagees: {
            "carousel-main-title": "Être présents<br><span>pour les plus isolés</span>",
            "carousel-main-text": "«&nbsp;Pour moi cette rencontre avec Chantal c’est une bénédiction. Madame Chantal est d’une telle gentillesse, de petites attentions de rien du tout, qui vous font un bien fou ! Je suis seul, je n'ai pas de famille vous comprenez. La gratitude que je ressens pour Chantal va bien au-delà des services rendus, c’est sa présence qui compte. Le fait d'être juste là, simplement. Je ne m'attends à rien et tout d’un coup, j’ai juste ce qui me manque. Madame Chantal s’aperçoit de tout, elle ne vous dit rien, mais elle agit. C’est une perle.&nbsp;»",
            "carousel-signature": "Guy, 91 ans",
            "carousel-second-text": "Chaque année nous effectuons 150 000 visites à domicile notamment auprès de femmes et d'hommes seuls souvent âgés. A celles-ci s'ajoutent les 50 000 visites en institution : hôpital, maison de retraite&nbsp;…",
            value: 2,
            icon: "/noelfraternel/dist/asset/img/aged.svg"
        },
        reveillon: {
            "carousel-main-title": "Créer des moments fraternels<br><span>hors du temps</span>",
            "carousel-main-text": "«&nbsp;L'objectif du réveillon solidaire que nous organisons c'est de se rencontrer, parler tout simplement dans une ambiance conviviale, bon enfant. On partage un bon repas, dans une ambiance festive. Pour les personnes reçues, c’est un véritable moment de déconnexion. Un instant hors du temps où ils oublient leurs problèmes quotidiens. Nous avons une équipe de bénévoles pour la décoration de la salle, une autre pour préparer un dîner de fête mais aussi pour l’animation, les chants et quelques bénévoles assurent aussi l’accueil… Nos bénévoles donnent leur temps, mais ils reçoivent tellement en retour...&nbsp;».",
            "carousel-signature": 'Vincent, bénévole de la Conférence Jeunes du 14e, à Paris.',
            "carousel-second-text": "Chaque année, nous invitons des centaines de personnes à nos goûters, réveillons, repas de Noël et de la Saint-Sylvestre, et offrons des jouets aux enfants démunis. Par un don, vous partagez l’espérance et la joie de la Nativité avec les personnes isolées.",
            value: 3,
            icon: "/noelfraternel/dist/asset/img/eve.svg"
        }
    },
    container = $(".carousel-container"),
    carouselMenu = $(".carousel-menu"),
    carouselMenuItem = $(".carousel-menu-item"),
    carouselMainTitle = $("#carousel-main-title"),
    carouselMainText = $("#carousel-main-text"),
    carouselSignature = $("#carousel-signature"),
    carouselSecondText = $("#carousel-second-text"),
    carouselMenuIcon = $(".icon-title"),
    equi = {
        0: "familles",
        1: "personnesalarue",
        2: "personnesagees",
...
}), carouselMenuItem.each(function() {
    $(this).click(function() {
        container.animate({
            left: "-175%",
            opacity: 0
        }, 1250), container.animate({
            left: "100%"
        }, 50);
        var e = carouselContent[$(this).attr("id")];
        $("#carousel-desktop").carousel(e.value), $("#carousel-mobile").carousel(e.value), $(".slick-carousel").slick("slickGoTo", e.value), setTimeout(function() {
            carouselMainTitle.html(e["carousel-main-title"]), carouselMainText.html(e["carousel-main-text"]), carouselSignature.html(e["carousel-signature"]), carouselSecondText.html(e["carousel-second-text"]), carouselMenuIcon.attr("src", e.icon)
        }, 1e3), container.animate({
            left: 0,
            opacity: 1
        }, 1250), carouselMenuItem.each(function() {
            $(this).removeClass("active")
        }), $(this).addClass("active")
    })
}), $(".slick-carousel").on("afterChange", function(e, t, n) {
    carouselMenuItem.each(function() {
        $(this).removeClass("active")
    }), $("#" + equi[n]).addClass("active")
}), $("#carousel-desktop").on("slide.bs.carousel", function(e) {
    var t, n, i, o, s, r, a;
    t = e, n = "left", i = $(t.currentTarget), o = i.find(".carousel-indicators"), s = i.find(".carousel-item"), e = i.find(".carousel-item.active"), r = $(t.relatedTarget), a = r.index(), void 0 === n && (n = "left"), t.direction !== n && (t.preventDefault(), "right" === n ? (r.insertBefore(e), i.carousel("prev"), setTimeout(function() {
        a === s.length - 1 ? r.insertAfter(s.eq(a - 1)) : r.insertBefore(s.eq(a + 1))
    }, 50)) : (r.insertAfter(e), i.carousel("next"), setTimeout(function() {
        0 === a ? r.insertBefore(s.eq(1)) : r.insertAfter(s.eq(a - 1))
    }, 50)), o.find(".active").removeClass("active"), o.children().eq(a).addClass("active"))
});
var donContent = {
        19: {
            text: "Avec 75&nbsp;€ vous participez à l'organisation de repas de fêtes. Grâce à vous, les personnes isolées vivront elles aussi la joie de Noël !"
        },
        41: {
            text: "Avec 165&nbsp;€ vous offrez des colis alimentaires à des personnes âgées et des familles que nous visitons régulièrement."
        },
        50: {
            text: "Avec 200&nbsp;€ vous offrez 4 mois de chauffage à une famille qui souffre du froid."
        }
    },
    after = $("#after-value"),
    afterText = $("#after-text"),
    link = $("#cta-target-link");
$("#nav-1 a").on("click", function(e) {
    ...
    after.animate({
        opacity: 0
    }, 250), afterText.animate({
        opacity: 0
    }, 250), setTimeout(function() {
        afterText.html(donContent[n].text), after.text(n + "€")
    }, 250), after.animate({
        opacity: 1
    }, 250), afterText.animate({
        opacity: 1
    }, 250), link.attr("href", $(this).attr("href")), $(this).parent().parent().find(".active").removeClass("active"), $(this).addClass("active")
}), $("#nav-1 a").on("mouseover", function() {
    var e = $(this).parent().position(),
        t = $(this).parent().width();
    $("#nav-1 .slide2").css({
        opacity: 1,
        left: +e.left,
...
var currentWidth = $("#nav-1 .nav").find(".active").parent("li").width(),
    current = $(".nav .active").position();
$("#nav-1 .slide1").css({
    left: +current.left,
    width: currentWidth
}), $(window).resize(function() {
    var e = $("#nav-1 a.active"),
        t = $(e).parent().position(),
        e = $(e).parent().width();
    $("#nav-1 .slide1").css({
        opacity: 1,
    ...
    jQuery.get(e, function(e) {
        e = jQuery(e).find("svg");
        void 0 !== n && (e = e.attr("id", n)), void 0 !== i && (e = e.attr("class", i + " replaced-svg")), e = e.removeAttr("xmlns:a"), t.replaceWith(e)
    }, "xml")
});
